...
"""
Given a path, recursively get a list of all files that are duplicates
and write them to a CSV file. The md5 checcksum for each file will
determine the which are duplicates.
"""
...
if __name__ == "__main__":
    ...
    print("Done: duplicates.csv has been written.")
